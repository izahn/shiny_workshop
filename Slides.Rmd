...
- Start Rstudio
- Open `shiny_workshop_materials.Rproj` (*File \rightarrow Open Project \rightarrow `shiny_workshop_materials.Rproj`*)
- Open shiny cheatsheet (*Help \rightarrow Cheat sheets \rightarrow Web applications with shiny*)
...
- It is often helpful to `print` or use `str` to examine inputs in your server function so you know what you're dealing with.
...
## Exercise: Spiff up the storms app
...
> - Tutorial available at https://campus.datacamp.com/courses/interactive-maps-with-leaflet-in-r
...
## Creating your own reactive values

## Interdependent input elements

## Delaying reactive element updates
